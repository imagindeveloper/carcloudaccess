...
const requiredParams = ['make', 'model', 'angle', 'filetype', 'compare', 'width', 'tailoring', 'dome', 'steering', 'modelyear', 'transmission', 'bodyvariant', 'bodysize', 'interior', 'trim', 'bodycolor', 'roofcolor', 'rimid', 'locality'];
