  ...
  return new Promise((resolve) => {
    ...
    imageRequest.onreadystatechange = function () {
      if (this.readyState === this.HEADERS_RECEIVED) {
        let nearMatchingStatus = parseInt(<string>this.getResponseHeader('x-carcloudaccess-nearmatching')) || 0;
...
export const getImageStatus = (imageURL: string, angleOverride: string, params:any= <any>{}, getMethod: string = 'getImage') => {
  return new Promise((resolve) => {
